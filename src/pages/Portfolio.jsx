...
export default function Portfolio() {
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      summary: 'Awaken your unique beauty and shine with confidence. Specialists in frizzy, curly and wavy hair in Lisbon.',
      projectUrl: 'https://mellifluous-blini-486d4a.netlify.app/',
    },
    {
      title: 'wanderlustsalono',
      location: 'Remote / Global',
      category: 'startups',
      beforeMetric: 'Standard CV template',
      afterMetric: 'Glassmorphic interactive showcase',
      growth: '100% Perf',
      services: ['Next.js App Router', 'Tailwind CSS Grid', 'Docker & CI/CD Pipelines'],
      summary: 'BOLD, BRAVE, AND BEAUTIFUL CHANGE IT UP WITH A NEW LOOK THAT AS FEARLESS AS YOU',
      projectUrl: 'https://wanderlustsalon.netlify.app/',
    },
    {
      title: 'hack-sapiens',
      location: 'Remote / Global',
      ...
      growth: '100% Perf',
      services: ['Next.js App Router', 'Tailwind CSS Grid', 'Docker & CI/CD Pipelines'],
      summary: 'dedicated to revolutionizing healthcare accessibility for remote and underserved communities through innovative telemedicine solutions. Our mission is to bridge the gap in healthcare delivery by leveraging cutting-edge technology to provide timely medical consultations and diagnoses, reducing the need for physical travel to healthcare facilities.',
      projectUrl: 'https://hack-sapiens-my27.vercel.app/',
    },
    {
      title: 'antriksh',
      location: 'Remote / Global',
      ...
      growth: '100% Perf',
      services: ['Next.js App Router', 'Tailwind CSS Grid', 'Docker & CI/CD Pipelines'],
      summary: 'a center of excellence in technical education',
      projectUrl: 'https://antriksh-theta.vercel.app/',
